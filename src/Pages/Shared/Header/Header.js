...
const Header = () => {
  return (
    <div className="text-gray-100 body-font shadow-lg fixed w-full bg-white">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav className="h-full md:ml-auto flex flex-wrap items-center text-base justify-center">
          ...
          <NavLink to='/shop' activeClassName="font-semibold text-textPrimary" className="mr-5 text-black hover:text-gray-300">Shop</NavLink>
