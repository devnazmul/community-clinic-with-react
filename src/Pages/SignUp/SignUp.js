  ...
  return (
    <div className="SignUp pt-36 flex justify-center items-center h-screen">
      <div className="w-full md:w-1/2 flex">
        <div onSubmit={handleRegistration} className="bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
          <form>
          ...
          <input type="submit" value="Sign Up" className="w-full mt-8 text-white bg-bgPrimary border-0 py-2 px-6 focus:outline-none hover:bg-green-300 rounded text-lg" />
          </form>
          <button
